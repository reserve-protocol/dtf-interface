...
Status: in progress. This is an implementation plan for moving Register's Index DTF flows onto `@reserve-protocol/sdk` and `@reserve-protocol/react-sdk`. It is not proof that every referenced hook or SDK method exists.
