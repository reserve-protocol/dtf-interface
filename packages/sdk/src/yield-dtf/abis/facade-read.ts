export const facadeReadAbi = [
  ...
  {
    inputs: [{ internalType: "contract ITrading", name: "trader", type: "address" }],
    name: "auctionsSettleable",
    outputs: [{ internalType: "contract IERC20[]", name: "erc20s", type: "address[]" }],
    stateMutability: "view",
    type: "function",
  },
  {
    inputs: [{ internalType: "contract IRToken", name: "rToken", type: "address" }],
