...
export {
  ...
  getIndexDtfGovernanceActivity,
  getIndexDtfProposalFeed,
  getIndexDtfTopVoters,
  withIndexDtfProposalSummaryState,
  ...
  getIndexDtfVoteLockLifetimeTotals,
  getIndexDtfVoteLockState,
  getIndexDtfVoteLockTotals,
...
export {
  ...
  getYieldDtfProtocolStakingTotals,
  getYieldDtfTopVoters,
  mapYieldDtfProposalSummary,
  withYieldDtfProposalListStates,
