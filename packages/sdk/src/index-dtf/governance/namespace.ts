...
export function createIndexDtfGovernanceNamespace(client: DtfClient) {
  return {
    ...
    getProposalFeed: (params?: GetIndexDtfProposalFeedParams) => getProposalFeed(client, params),
    getTopVoters: (params?: GetIndexDtfTopVotersParams) => getTopVoters(client, params),
    getGovernanceActivity: (params?: GetIndexDtfGovernanceActivityParams) => getGovernanceActivity(client, params),
