export const revenueTraderAbi = [
  ...
  {
    inputs: [{ internalType: "contract IERC20[]", name: "erc20s", type: "address[]" }],
    name: "returnTokens",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [{ internalType: "contract IERC20", name: "sell", type: "address" }],
    name: "settleTrade",
    outputs: [{ internalType: "contract ITrade", name: "trade", type: "address" }],
    stateMutability: "nonpayable",
    type: "function",
  },
  {
